        ...
        <section class="menu-content">
            ...
            if(mysqli_num_rows($result1) > 0) {
                while($row1 = mysqli_fetch_assoc($result1)){
                    ...
                    $car_id = isset($row1["CAR_ID"]) ? $row1["CAR_ID"] : "N/A";
                    $car_name = isset($row1["CAR_NAME"]) ? $row1["CAR_NAME"] : "Car Name Not Available";
                    $car_img = isset($row1["CAR_IMG"]) ? $row1["CAR_IMG"] : "assets/default-car.jpg"; // Default image
                    $ac_price = isset($row1["AC_PRICE"]) ? $row1["AC_PRICE"] : "N/A";
                    $ac_price_per_day = isset($row1["AC_PRICE_PER_DAY"]) ? $row1["AC_PRICE_PER_DAY"] : "N/A";
                    $non_ac_price = isset($row1["NON_AC_PRICE"]) ? $row1["NON_AC_PRICE"] : "N/A";
                    $non_ac_price_per_day = isset($row1["NON_AC_PRICE_PER_DAY"]) ? $row1["NON_AC_PRICE_PER_DAY"] : "N/A";
               
                    ?>
            <!-- <a href="booking.php?id=<?php echo($car_id) ?> -->
            <a href="booking.php?id=1<?php echo($car_id) ?>">
